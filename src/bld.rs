...
/// example the super_manager module has a struct [SuperContainer] that
/// configures a container's create arguments to facilitate testing.
///
...
pub mod super_configurator;
/// Constructs for managing containers in a controlled environment.
/// Useful for creating integration tests and examples.
///
/// This module uses [SuperContainer] and adds a simple way to declare a docker
/// network, run `docker start` and check the outputs (stdout, stderr) for
/// effective testing.
pub mod super_manager;

// TODO: move SuperContainer to super_manager and create the testing facilities
...
pub mod docker_socket {
    ...
    pub async fn get_or_init_docker_instance() -> Result<bollard::Docker> {
