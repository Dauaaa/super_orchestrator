...
// TODO: move
pub struct SuperContainer {
    image: SuperImage,
}

/// Use this to create a docker file representation equivalent. It's one of the
/// required inputs for creating a [SuperContainer].
///
...
/// Wrapper for the image, call [SuperImage::get_image_id] to get the id of the
/// image as a &str.
#[derive(Debug, Clone)]
